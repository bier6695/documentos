...
$(document).ready(function(){
	...
	$(document).on('keyup','header div input, #search .form input',function(){
		var e = $(this), v = e.val();
		if(v.length){
			if(!ismob()) if(!$('#box').length) $('main').append('<div id="box"><i class="ion-close-circled"></i><div class="inner"><h2>Resultados en pelÃ­culas</h2><div id="result" class="mov">');
...
if(ismob()){
	$('header').prepend('<i class="ion-navicon-round"></i><div id="menu"></div><div id="search"><div class="form"><i class="ion-search"></i></div><h3>Resultados en pelÃ­culas</h3><div id="result" class="mov">');
