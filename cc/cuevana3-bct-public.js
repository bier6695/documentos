  ...
  'use strict';
    ...
    if( search_ ) {
        ...
        var loadDoc = function loadDoc() {
            ...
            xhttp.open("GET", "https://cuevana3.io/wp-content/themes/cuevana3/b2.json", true);
...
jQuery(document).ready(function($){
    ...
    $('#editor-user-pass').on('submit', function(event) {
        ...
        if( pass !== passRepeat ) {
            var html = '';
            html += '<p id="error-tpt" style="margin-top: 10px;" class="msg-d fa-exclamation-triangle">Las contraseñas no coinciden</p>';
            ...
            success: function( data ) {
                ...
                if(status == 'favorito') {
                    ...
                    swal({
                      position: 'center',
                      type: 'warning',
                      title: 'Se eliminó a tu lista correctamente',
                    ...
                    swal({
                      position: 'center',
                      type: 'success',
                      title: 'Se añadió a tu lista correctamente',
                      showConfirmButton: false,
                      timer: 1500
                    })
                }
                ...
                if(status == 'recomendado') {
                    ...
                    $this.attr('data-status', 'norecomendado');
                     swal({
                      position: 'center',
                      type: 'warning',
                      title: 'Se eliminó de recomendados correctamente',
                      showConfirmButton: false,
                      timer: 1500
                    })
                   ...
                   // $this.addClass('far');
                    ...
                    swal({
                      position: 'center',
                      type: 'success',
                      title: 'Se añadió a recomendados correctamente',
                      showConfirmButton: false,
                      timer: 1500
                    })
                }
    ...
    /**
     * HOME MAIN
     * Tab movies: últimas, estrenos, ranking, mas vistos
     */
    ...
    /**
     * HOME MAIN
     * Tab series: últimas, estrenos, ranking, mas vistos
     */
